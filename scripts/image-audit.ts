...
console.log('TODO revisit if we flesh out AphexMetadata with output data')
...
// import { AphexMetadata, getTags } from '../src/utilities/image/tags'
...
// 	let validImages = 0
// 	let processingOptions: AphexMetadata['exportOptions']['processOptions'] | undefined
// 	let exportOptions: AphexMetadata['exportOptions']['exportOptions'] | undefined
...
// 		const { aphexMetadata: metadata } = await getTags(path)
